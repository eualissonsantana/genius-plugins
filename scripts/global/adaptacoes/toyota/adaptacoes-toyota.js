function header() {
    ...
    logoToyota.innerHTML = '<img class="navbar__logo-toyota" alt="Logo da Toyota com fundo branco, letras pretas e símbolo branco com fundo vermelho" src="https://legado.autoforce.com.br/static/toyota/images/Toyota_logo_2019.png" />'
    ...
    logoToyotaMob.innerHTML = '<img class="navbar__logo-toyota" alt="Logo da Toyota com fundo branco, letras pretas e símbolo branco com fundo vermelho" src="https://legado.autoforce.com.br/static/toyota/images/Toyota_logo_2019_mob.png" />'
...
const makeFooterHeader = (dealerName) => {
    ...
    <div class="footer__header">
        ...
        <img alt="Logo Ibama" src="https://legado.autoforce.com.br/static/toyota/images/IBAMA_Convertido.svg" />
        <p>Juntos salvamos vidas.</p>
        </div>
        <div class="footer__dealer-logo">
        <img alt"Logo Toyota" src="https://legado.autoforce.com.br/plugins/images/global/adaptacoes/toyota/logo/toyota-logo.png" />
        </div>
    </div>
`
}
