(()=>{function a(){(({styles:c})=>{let b=c,d=document.head||document.getElementsByTagName("head")[0],a=document.createElement("style");d.appendChild(a),a.setAttribute("type","text/css"),a.styleSheet?a.styleSheet.cssText=b:a.appendChild(document.createTextNode(b))})({styles:`
      ...
      `});let b=document.querySelector(".footer__signature"),a=document.querySelector("footer.footer");b.innerHTML=`<div class="container">${b.innerHTML.replace("https://assets.autoforce.com/assets/home/logo-3e7a9840df57c209a6620c93e913bcc1d937648fc51c54cada7989b1c2db9850.png","https://legado.autoforce.com.br/static/toyota/images/logoaf_preta-07.svg")}</div>`,a.appendChild(b);let c=document.createElement("div");c.classList.add("container");let e=a=>`
        ...
        `;let a=document.querySelectorAll(".nav--accordion-mobile .nav-item");a&&a.forEach(a=>{a.innerHTML.includes("Ofertas \xdanicas")?a.remove():a.innerHTML.includes("Agendamento de servi\xe7o")&&a.remove()})}a(),b(),c(),d(),e(),f(),g(),h(),i(),j(),k(),l(),m(),n(),o(),p()})()