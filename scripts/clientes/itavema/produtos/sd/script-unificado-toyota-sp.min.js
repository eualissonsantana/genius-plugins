(()=>{function a(){(({styles:c})=>{let b=c,d=document.head||document.getElementsByTagName("head")[0],a=document.createElement("style");d.appendChild(a),a.setAttribute("type","text/css"),a.styleSheet?a.styleSheet.cssText=b:a.appendChild(document.createTextNode(b))})({styles:`
            ...
            `});let c=document.querySelector(".header .header__navbar"),a=document.createElement("div");a.classList.add("header__navbar-item"),a.innerHTML='<img class="navbar__logo-toyota" src="https://legado.autoforce.com.br/static/toyota/images/Toyota_logo_2019.png" />',c.appendChild(a);let d=document.querySelector(".header-mobile__buttons"),b=document.createElement("div");b.classList.add("header__navbar-item"),b.innerHTML='<img class="navbar__logo-toyota" src="https://legado.autoforce.com.br/static/toyota/images/Toyota_logo_2019_mob.png" />',d.parentElement.appendChild(b)}function b(){(({styles:c})=>{let b=c,d=document.head||document.getElementsByTagName("head")[0],a=document.createElement("style");d.appendChild(a),a.setAttribute("type","text/css"),a.styleSheet?a.styleSheet.cssText=b:a.appendChild(document.createTextNode(b))})({styles:`
        footer.footer {
          background-color: #F2F2F2;
        }
