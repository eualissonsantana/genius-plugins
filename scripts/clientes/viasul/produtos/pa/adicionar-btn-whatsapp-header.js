(() => {
    ...
    if(headerCta){
        ...
        dropdownWhatsapp.innerHTML = `
            <span>
                <a class="dropdown-item" href="https://api.whatsapp.com/send?phone=5571984302642" target="_blank">
                    <i class="icon icon-whatsapp"></i>
                    <span class="titulo">Jeep Rio Vermelho</span>
                    <strong class="text-nowrap text-mask-phone">(71) 98430-2642</strong>
                </a>
                <a class="dropdown-item" href="https://api.whatsapp.com/send?phone=5571981553212" target="_blank">
                    <i class="icon icon-whatsapp"></i>
                    <span class="titulo">Jeep ACM</span>
                    <strong class="text-nowrap text-mask-phone">(71) 98155-3212</strong>
                </a>
                <a class="dropdown-item" href="https://api.whatsapp.com/send?phone=5581991461062" target="_blank">
                    <i class="icon icon-whatsapp"></i>
                    <span class="titulo">Jeep Piedade</span>
                    <strong class="text-nowrap text-mask-phone">(81) 99146-1062</strong>
                </a>
                <a class="dropdown-item" href="https://api.whatsapp.com/send?phone=5581991148728" target="_blank">
                    <i class="icon icon-whatsapp"></i>
                    <span class="titulo">Jeep Imbiribeira</span>
                    <strong class="text-nowrap text-mask-phone">(81) 99114-8728</strong>
                </a>
                <a class="dropdown-item" href="https://api.whatsapp.com/send?phone=5585992125194" target="_blank">
                    <i class="icon icon-whatsapp"></i>
